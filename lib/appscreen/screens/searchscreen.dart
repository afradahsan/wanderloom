                        ...
                        child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: const EdgeInsets.symmetric(
                                  vertical: 5), // Adjust the padding here
                            ),
                            onChanged: (value) {
                              if (value.isEmpty) {
                                setState(() {
                                    ...
                                    ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return PlaceListTile(
                                              doc: doc,
                                              placeID: doc.id,
                                              imageDoc: doc['Image URL'],
                                              PlaceDoc: doc['Place Name'],
                                              LocationDoc: doc['Location']);
                                        }),
                                  ],
                                );
                              }));
                        ...
                        return Expanded(
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              var placeID =
                                  searchData[index].key; // Access the placeID
